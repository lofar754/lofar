...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.facebook.com/radha.paudel.7739')
    else:
        print "Wrong Username"
        os.system('xdg-open https://www.facebook.com/profile.php?id=100090194221837&mibextid=ZbWKwL')
def login():
	os.system('clear')
	try:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															a = requests.get('https://github.com/lofar754/tricker/blob/main/loffar.txthttps://github.com/lofar754/tricker/blob/main/loffar.txthttps://github.com/lofar754/tricker/blob/main/loffar.txt)
															b = json.loads(a.text)
